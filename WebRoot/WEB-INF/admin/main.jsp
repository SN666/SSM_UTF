...
<meta name="keywords" content="Lift Steap">
<meta name="description" content="床前明月光,地上......">
</head>
<body>
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">Administrator</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> 
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		 <c:forEach items="${power }" var="pow">
		 <c:if test="${ pow.fatherid == 0}">
		 <dl id="menu-system">
			<dt><i class="Hui-iconfont">${pow.powericon}</i> ${pow.powername}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
				<c:forEach items="${power }" var="po">
				<c:if test="${po.fatherid == pow.powerid }">
				 <li><a data-href="${po.powerurl }" data-title="${po.powername }" href="javascript:void(0)">${po.powername }</a></li>
		       	</c:if>
		       	 </c:forEach>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="${pageContext.request.contextPath}/user/list">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="list"></iframe>
	</div>
</div>
</section>
